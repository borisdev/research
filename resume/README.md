...
I start with getting my head around the ambiguities of the data's human value to the end user, and then work backwards through the data flow, searching for low-hanging fruit system design changes.
